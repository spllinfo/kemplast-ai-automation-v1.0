                    ...
                    <div>
                        <nav>
                            <ol class="breadcrumb mb-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Finished Jobs</li>
                            </ol>
                        </nav>
                        <h1 class="page-title fw-medium fs-18 mb-0">Finished</h1>
                    </div>
                    <div class="btn-list">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">1,985</h4>
                                    </div>
                                    <div class="lh-1">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">892</h4>
                                    </div>
                                    <div class="lh-1">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">357</h4>
                                    </div>
                                    <div class="lh-1">
                                            ...
                                            <tr class="task-list">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.html">Plastic Wraps 249X53 CM 300X60 CM</a></p>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="javascript:void(0);" class="fw-medium mb-0">BMW Auto Mobile</a>
                                                    </div>
                                                </td>
                                                <td>09-03-2025</td>
                                            ...
                                            <tr class="task-list">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                            <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.html">
Plastic Wraps 387X231 CM</a></p>
                                                ...
                                                <td>
                                                    <div>
                                                        <span class="text-primary">70% Completed</span><br>
                                                        <span>Qty: 390KG/14</span>
                                                        <div class="progress progress-xs">
                                                 ...
                                                 <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-primary"  data-bs-toggle="modal" data-bs-target="#view-roll">14 Rolls / 390KG</a>
                                                    </div></td>
                                                ...
                                                <td><span class="badge bg-warning-transparent">High</span></td>
                                                 ...
                                                 <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-primary"  data-bs-toggle="modal" data-bs-target="#view-roll">3 Rolls / 150KG</a>
                                                    </div></td>
        ...
        <div class="card-body p-0">
            ...
            <table class="table table-hover text-nowrap">
                                                       ...
                                                       <input class="form-check-input check-all" type="checkbox" id="checkboxNoLabel1" value="" aria-label="...">
                                                                                       ...
                                                                                       <th scope="col">Status</th>
                                                                                       <th scope="col">FG Stock Location</th>
                                                                                       <th scope="col">Action</th>
                                                       ...
                                                       <input class="form-check-input" type="checkbox" id="checkboxNoLabel1" value="" aria-label="...">
                                                                                       ...
                                                                                       <td>
                                                                                                                  <div class="d-flex align-items-center">
                                                                                                                      ...
                                                                                                                      <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-warning"  data-bs-toggle="modal" data-bs-target="#move-extrution">Honda-I FG Store</a>
                                                                                                                  </div></td>
                                                                                       <td>
                                                       ...
                                                       <input class="form-check-input" type="checkbox" id="checkboxNoLabel1" value="" aria-label="...">
                                                                                    ...
                                                                                    <td>
                                                                                                                  <div class="d-flex align-items-center">
                                                                                                                      ...
                                                                                                                      <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-warning"  data-bs-toggle="modal" data-bs-target="#move-extrution">Honda-II FG Store</a>
                                                                                                                  </div></td>
                                                                                    <td>
                                                                                        <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#editDataModal">
                                                                                            <i class="ri-edit-line"></i>
                                                       ...
                                                       <input class="form-check-input" type="checkbox" id="checkboxNoLabel1" value="" aria-label="...">
                                                                                    ...
                                                                                    <td>
                                                                                                                  <div class="d-flex align-items-center">
                                                                                                                      ...
                                                                                                                      <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-warning"  data-bs-toggle="modal" data-bs-target="#move-extrution">Honda-III FG Store</a>
                                                                                                                  </div></td>
                                                                                    <td>
                                                                                        <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#editDataModal">
                                                                                            <i class="ri-edit-line"></i>
                                                       ...
                                                       <input class="form-check-input" type="checkbox" id="checkboxNoLabel1" value="" aria-label="...">
                                                                                    ...
                                                                                    <td>
                                                                                                                  <div class="d-flex align-items-center">
                                                                                                                      ...
                                                                                                                      <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-warning"  data-bs-toggle="modal" data-bs-target="#move-extrution">Warhouse 3</a>
                                                                                                                  </div></td>
                                                                                    <td>
                                                                                        <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#editDataModal">
                                                                                            <i class="ri-edit-line"></i>
                                                       ...
                                                       <input class="form-check-input" type="checkbox" id="checkboxNoLabel1" value="" aria-label="...">
                                                                                    ...
                                                                                    <td>
                                                                                                                  <div class="d-flex align-items-center">
                                                                                                                      ...
                                                                                                                      <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-warning"  data-bs-toggle="modal" data-bs-target="#move-extrution">Unit-3 FG Store</a>
                                                                                                                  </div></td>
                                                                                    <td>
                                                                                        <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#editDataModal">
                                                                                            <i class="ri-edit-line"></i>
