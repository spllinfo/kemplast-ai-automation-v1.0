                    ...
                    <div>
                        <nav>
                            <ol class="breadcrumb mb-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Slitting Jobs</li>
                            </ol>
                        </nav>
                        <h1 class="page-title fw-medium fs-18 mb-0">Slitting</h1>
                    </div>
                    <div class="btn-list">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">8,425</h4>
                                    </div>
                                    <div class="lh-1">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">3,142</h4>
                                    </div>
                                    <div class="lh-1">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">584</h4>
                                    </div>
                                    <div class="lh-1">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">158</h4>
                                    </div>
                                    <div class="lh-1">
                                            ...
                                            <tr class="task-list">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                             <p class="fw-medium mb-0 d-flex align-items-center"> <a href="javascript:void(0);" class="fw-medium mb-0 badge badge bg-primary-transparent"  data-bs-toggle="modal" data-bs-target="#move-slitting">Plastic Wraps 249X53 CM 300X60 CM</a></p>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-primary2"  data-bs-toggle="modal" data-bs-target="#move-slitting">Add Roll</a>
                                                    </div></td>
                                                <td>02-03-2025</td>
                                            ...
                                            <tr class="task-list">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                             <p class="fw-medium mb-0 d-flex align-items-center"> <a href="javascript:void(0);" class="fw-medium mb-0 badge badge bg-primary-transparent"  data-bs-toggle="modal" data-bs-target="#move-slitting">Ferrari Auto Part Bags</a></p>
                                            ...
                                            <tr class="task-list">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                             <p class="fw-medium mb-0 d-flex align-items-center"> <a href="javascript:void(0);" class="fw-medium mb-0 badge badge bg-primary-transparent"  data-bs-toggle="modal" data-bs-target="#move-slitting">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" id="checkboxNoLabel1" value="" aria-label="...">
                                                                                    ...
                                                                                    <td>
                                                                                                               <div class="d-flex align-items-center">
                                                                                                                   ...
                                                                                                                   <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-primary"  data-bs-toggle="modal" data-bs-target="#move-extrution">Move Cutting</a>
                                                                                                               </div></td>
                                                                                    <td>
