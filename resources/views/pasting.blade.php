                    ...
                    <div>
                        <nav>
                            <ol class="breadcrumb mb-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Pasting Jobs</li>
                            </ol>
                        </nav>
                        <h1 class="page-title fw-medium fs-18 mb-0">Pasting</h1>
                    </div>
                    <div class="btn-list">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">15,457</h4>
                                    </div>
                                    <div class="lh-1">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">3,584</h4>
                                    </div>
                                    <div class="lh-1">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">1,124</h4>
                                    </div>
                                    <div class="lh-1">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between mb-2">
                                    <div>
                                        ...
                                        <h4 class="fw-medium mb-0">254</h4>
                                    </div>
                                    <div class="lh-1">
                                            ...
                                            <tr class="task-list">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"> <a href="javascript:void(0);" class="fw-medium mb-0 badge badge bg-primary-transparent"  data-bs-toggle="modal" data-bs-target="#move-pasting">Plastic Wraps 249X53 CM 300X60 CM</a></p>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-primary2"  data-bs-toggle="modal" data-bs-target="#move-pasting">Add Roll</a>
                                                    </div></td>
                                                <td>02-03-2025</td>
                                            ...
                                            <tr class="task-list">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"> <a href="javascript:void(0);" class="fw-medium mb-0 badge badge bg-primary-transparent"  data-bs-toggle="modal" data-bs-target="#move-pasting">Ferrari Auto Part Bags</a></p>
                                            ...
                                            <tr class="task-list">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"> <a href="javascript:void(0);" class="fw-medium mb-0 badge badge bg-primary-transparent"  data-bs-toggle="modal" data-bs-target="#move-pasting">
