        ...
        <div class="d-flex align-items-center flex-wrap gap-2">
            <div class="form-group">
                <div class="input-group">
                    <div class="input-group-text border bg-white"> <i class="ri-calendar-line"></i> </div>
                    <input type="text"
            ...
            <div class="btn-list">
                <button class="btn btn-white btn-wave">
                    <i class="ri-filter-3-line lh-1 me-1 align-middle"></i> Filter
                </button>
        ...
        <div class="col-xl-8">
            <div class="row">
                <div class="col-xxl-3 col-xl-6">
                    <div class="card custom-card main-content-card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="text-muted fs-13">Increased By <span class="text-success">6.56%<i
                ...
                <div class="col-xxl-3 col-xl-6">
                    <div class="card custom-card main-content-card overflow-hidden">
                        <div class="card-body">
                            ...
                            <div class="text-muted fs-13">Decreased By <span class="text-danger">0.004%<i
                        ...
                        <div class="card-header justify-content-between">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu"
                                    ...
                                    <li><a class="dropdown-item"
                                           href="javascript:void(0);">This Month</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-header justify-content-between pb-0">
                            ...
                            <div class="dropdown">
                                <a aria-label="anchor"
                                   ...
                                   class="btn btn-light btn-icons btn-sm text-muted"
                                   data-bs-toggle="dropdown"
                                   aria-expanded="false">
                        ...
                        <div class="card-body px-3 py-4">
                            <div class="d-flex mb-3 gap-3">
                                ...
                                <div class="flex-fill d-flex align-items-start justify-content-between">
                                    <div>
                                        <span class="fs-11 d-block fw-medium mb-1">TOTAL ORDERS</span>
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h4 class="d-flex align-items-center mb-0">98,736<span
                                                      class="text-success fs-12 op-1 ms-2"><i
                                                       class="ti ti-trending-up me-1 align-middle"></i>0.57%</span></h4>
                                        </div>
                                    </div>
                                    <a href="javascript:void(0);"
                                       class="text-success fs-12 text-decoration-underline">Increased ?</a>
                                </div>
                            </div>
                            <div id="orders"
                                 class="my-2"></div>
                        ...
                        <div class="card-footer border-top border-block-start-dashed">
                            <div class="d-grid">
                                <button
                                    ...
                                    Statistics<i class="ti ti-arrow-narrow-right fs-16 d-inline-block ms-2"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body p-4">
                            <div class="row justify-content-between">
                                <div class="col-xxl-7 col-xl-5 col-lg-5 col-md-5 col-sm-5">
                                    <h4 class="fw-medium text-fixed-white mb-2">Enhance Production</h4>
                                    <p class="text-fixed-white mb-1">Analyze metrics, track performance, gain insights to
                                        drive your business forward.</p>
                                    <a href="javascript:void(0);"
                                       class="fw-medium text-fixed-white text-decoration-underline">Production Plans<i
                                           class="ti ti-arrow-narrow-right"></i></a>
                                </div>
                                <div
                                     class="col-xxl-4 col-xl-7 col-lg-7 col-md-7 col-sm-7 d-sm-block d-none my-auto text-end">
                                    <img src="{{ asset('assets/images/media/media-85.png') }}"
                                         alt=""
                                         class="img-fluid">
                                </div>
                            </div>
                        ...
                        <div class="card-body p-0">
                            <div class="p-3 pb-0">
                                <div class="progress-stacked progress-sm mb-2 gap-1">
                                    ...
                                    <div class="progress-bar bg-primary1"
                                         role="progressbar"
                                         style="width: 20%"
                                         aria-valuenow="20"
                                         aria-valuemin="0"
                                         aria-valuemax="100"></div>
                                    <div class="progress-bar bg-primary2"
                                         role="progressbar"
                                         style="width: 25%"
                                         aria-valuenow="25"
                                         aria-valuemin="0"
                                         aria-valuemax="100"></div>
                                    <div class="progress-bar bg-primary3"
                                         role="progressbar"
                                         style="width: 15%"
                                         aria-valuenow="15"
                                         aria-valuemin="0"
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <div class="h6 mb-0"><span class="text-success fs-11 me-2">3.12%<i
                                               class="ti ti-arrow-narrow-up"></i></span>1,58,643</div>
                                </div>
                            </div>
                                ...
                                <table class="table text-nowrap">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <span class="badge bg-success">1.25% <i
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <span class="badge bg-warning">0.89% <i
                                                       class="ti ti-trending-up"></i></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <span class="fw-medium top-category-name three">Bio Printed Carry
                                                    Bags</span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                <span class="badge bg-secondary">1.02% <i
                                                       class="ti ti-trending-up"></i></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <span class="badge bg-primary1">0.58% <i
                                                       class="ti ti-trending-up"></i></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="border-bottom-0 text-end">
                                                <span class="badge bg-primary">1.47% <i
                                                       class="ti ti-trending-up"></i></span>
                                            </td>
                                        </tr>
                                    </tbody>
        ...
        <div class="col-xxl-3 col-xl-6">
            <div class="card custom-card overflow-hidden">
                <div class="card-header justify-content-between">
                    ...
                    <a href="javascript:void(0);"
                       class="btn btn-light btn-wave btn-sm text-muted">View All<i
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="lh-1">
                                                <span class="avatar avatar-sm">
                                                    <img src="{{ asset('assets/images/media/12raw-m.jpg') }}"
                                                         alt="LLD">
                                                </span>
                                            </div>
        ...
        <div class="col-xxl-3">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <button type="button"
                            class="btn btn-sm btn-primary-light">View All</button>
                </div>
                <div class="p-3 pb-2">
                    <div class="d-flex align-items-start mb-3 gap-3">
                        <div class="flex-grow-1">
                            <p class="fw-medium fs-14 mb-1">Extrusion Process <a href="javascript:void(0);"
                                   class="text-info"
                                   data-bs-toggle="tooltip"
                                   data-bs-placement="top"
                                   data-bs-title="Get Info"><i
                                       class="ri-information-2-line fs-13 op-7 lh-1 align-middle"></i></a></p>
                            <p class="text-muted fw-normal fs-12 mb-1">Extrusion of polyethylene film for bag production.
                            </p>
                            <div>Status: <span class="text-success fw-normal fs-12">80% completed</span></div>
                        </div>
                        <div class="flex-shrink-0 text-end">
                            <p class="fs-11 text-muted mb-3"><i
                                   class="ri-time-line text-muted fs-11 lh-1 d-inline-block me-1 align-middle"></i>5mins
                                ago</p>
                            <div class="avatar-list-stacked">
                                <span class="avatar avatar-sm avatar-rounded">
                                    <img src="{{ asset('assets/images/faces/11.jpg') }}"
                                         alt="img">
                                </span>
                                <span class="avatar avatar-sm avatar-rounded">
                    ...
                    <div>
                        <div class="progress progress-lg rounded-pill bg-primary-transparent ms-auto p-1"
                             role="progressbar"
                             aria-valuenow="80"
                             aria-valuemin="0"
                             aria-valuemax="100">
                ...
                <div class="p-3 pb-2">
                    <div class="d-flex align-items-start mb-3 gap-3">
                        <div class="flex-grow-1">
                            <p class="fw-medium fs-14 mb-1">Cutting and Sealing <a href="javascript:void(0);"
                                   class="text-info"
                                   data-bs-toggle="tooltip"
                                   data-bs-placement="top"
                                   data-bs-title="Get Info"><i
                                       class="ri-information-2-line fs-13 op-7 lh-1 align-middle"></i></a></p>
                            <p class="text-muted fw-normal fs-12 mb-1">Cutting and sealing bag material into desired sizes.
                            </p>
                            <div>Status: <span class="text-warning fw-medium fs-12">69% completed</span></div>
                        </div>
                        <div class="flex-shrink-0 text-end">
                            <p class="fs-11 text-muted mb-3"><i
                                   class="ri-time-line text-muted fs-11 lh-1 d-inline-block me-1 align-middle"></i>20mins
                                ago</p>
                            <div class="avatar-list-stacked">
                                <span class="avatar avatar-sm avatar-rounded">
                                    <img src="{{ asset('assets/images/faces/11.jpg') }}"
                    ...
                    <div>
                        <div class="progress progress-lg rounded-pill flex-fill bg-primary1-transparent ms-auto p-1"
                             role="progressbar"
                             aria-valuenow="50"
                             aria-valuemin="0"
                             aria-valuemax="100">
                ...
                <div class="p-3">
                    <div class="d-flex align-items-start mb-3 gap-3">
                        <div class="flex-grow-1">
                            <p class="fw-medium fs-14 mb-1">Printing on Bags <a href="javascript:void(0);"
                                   class="text-info"
                                   data-bs-toggle="tooltip"
                                   data-bs-placement="top"
                                   data-bs-title="Get Info"><i
                                       class="ri-information-2-line fs-13 op-7 lh-1 align-middle"></i></a></p>
                            <p class="text-muted fs-12 mb-1">Printing logos and designs on manufactured bags.</p>
                            <div>Status: <span class="text-success fw-medium fs-12">52% completed</span></div>
                        </div>
                        <div class="flex-shrink-0 text-end">
                            <p class="fs-11 text-muted mb-3"><i
                                   class="ri-time-line text-muted fs-11 lh-1 d-inline-block me-1 align-middle"></i>30mins
                                ago</p>
                            <div class="avatar-list-stacked">
                                <div class="avatar-list-stacked">
                                    <span class="avatar avatar-sm avatar-rounded">
                                    ...
                                    <a class="avatar avatar-sm bg-primary avatar-rounded text-fixed-white border border-2"
                    ...
                    <div>
                        <div class="progress progress-lg rounded-pill flex-fill bg-primary2-transparent ms-auto p-1"
                             role="progressbar"
                             aria-valuenow="65"
                             aria-valuemin="0"
                             aria-valuemax="100">
        ...
        <div class="col-xxl-6">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div>
                        <button type="button"
                                class="btn btn-primary-light btn-sm"><i
                               class="ri-share-forward-line d-inline-block me-1 align-middle"></i>Export</button>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="lh-1">
                                                <span class="avatar avatar-sm">
                                                    <img src="{{ asset('assets/images/faces/12.jpg') }}"
                                                         alt="">
                                                </span>
                                            </div>
                                            <div>
                    ...
                    <ul class="list-unstyled sales-country-list">
                        <li>
                            <div class="d-flex align-items-start gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-sm bg-light border p-1">
                                ...
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="d-block fw-medium lh-1 mb-2">Honda Unit-5</span>
                        ...
                        <li>
                            <div class="d-flex align-items-start gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-sm bg-light border p-1">
                                        <img src="{{ asset('assets/images/company-logos/2.png') }}"
                                             alt="">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="d-block fw-medium lh-1 mb-2">
                                            TVS Motors</span>
                        ...
                        <li>
                            <div class="d-flex align-items-start gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-sm bg-light border p-1">
                                        <img src="{{ asset('assets/images/company-logos/3.png') }}"
                                             alt="">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="d-block fw-medium lh-1 mb-2">Tata Motors</span>
                        ...
                        <li>
                            <div class="d-flex align-items-start gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-sm bg-light border p-1">
                                        <img src="{{ asset('assets/images/company-logos/4.png') }}"
                                             alt="">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="d-block fw-medium lh-1 mb-2">Green Foods</span>
                        ...
                        <li>
                            <div class="d-flex align-items-start gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-sm bg-light border p-1">
                                        <img src="{{ asset('assets/images/company-logos/5.png') }}"
                                             alt="">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="d-block fw-medium lh-1 mb-2">Honda Unit-2</span>
                        ...
                        <li>
                            <div class="d-flex align-items-start gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-sm bg-light border p-1">
                                        <img src="{{ asset('assets/images/company-logos/6.png') }}"
                                             alt="">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="d-block fw-medium lh-1 mb-2">Rolls Royce Unit-5</span>
                        ...
                        <li>
                            <div class="d-flex align-items-start gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-sm bg-light border p-1">
                                        <img src="{{ asset('assets/images/company-logos/9.png') }}"
                                             alt="">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <span class="d-block fw-medium lh-1 mb-2">Customer 7</span>
