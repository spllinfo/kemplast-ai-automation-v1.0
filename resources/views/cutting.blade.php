                    ...
                    <div>
                        <nav>
                            <ol class="breadcrumb mb-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Cutting Jobs</li>
                            </ol>
                        </nav>
                        <h1 class="page-title fw-medium fs-18 mb-0">Cutting</h1>
                    </div>
                    <div class="btn-list">
                                            ...
                                            <tr class="task-list">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="javascript:void(0);" class="fw-medium mb-0">Ferrari Auto Mobile</a>
                                                    </div>
                                                </td>
                                                <td>09-03-2025</td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-primary2"  data-bs-toggle="modal" data-bs-target="#move-cutting">Add Roll</a>
                                                    </div></td>
                                                <td>02-03-2025</td>
                                            ...
                                            <tr class="task-list">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="javascript:void(0);" class="fw-medium mb-0">GT Ford Unit-3</a>
                                                    </div>
                                                </td>
                                                <td>02-02-2025</td>
...
Plastic Wraps 387X231 CM</a></p>
                                                ...
                                                <td>
                                                    <div>
                                                        <span class="text-success">50% Completed</span><br>
                                                        <span>Qty: 250KG/10</span>
                                                        <div class="progress progress-xs">
                                                            <div class="progress-bar bg-success" style="width: 100%"></div>
                                                        </div>
                                                    </div>
                                                 ...
                                                 <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <a href="javascript:void(0);" class="fw-medium mb-0 badge btn-primary"  data-bs-toggle="modal" data-bs-target="#view-roll">10 Rolls / 250KG</a>
                                                    </div></td>
