(function () {
    ...
    var quill = new Quill('#product-features2', {
        modules: {
            toolbar: toolbarOptions
        },
        theme: 'snow'
    ...
    FilePond.create(MultipleElement,);
     ...
     // for product images upload
     const MultipleElement3 = document.querySelector('.product-Images2');
     FilePond.create(MultipleElement3,);
 
     // for documents upload
     const MultipleElement4 = document.querySelector('.product-documents2');
     FilePond.create(MultipleElement4,);
